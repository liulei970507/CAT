...
from model_stage2_x2guidex1 import *
from pretrain_options import *
from tracker_stage2_x2guidex1 import *
import numpy as np
...
def train_mdnet():
    ...
    for i in range(pretrain_opts['n_cycles']):
        ...
        if cur_score > best_score:
            ...
            if pretrain_opts['use_gpu']:
                model = model.cpu()
            states = {'guidance1_conv0_21': model.guidance1_conv0_21.state_dict(),
...
if __name__ == "__main__":
    ...
    parser.add_argument("-model_path", default ="/home/liulei/cat/models/RGBT234_x2guidex1.pth", help = "model path")
