...
class MDNet(nn.Module):
    ...
    def load_model(self, model_path):
        ...
        # parallel1
        self.parallel1[0].load_state_dict(torch.load('./models/RGBT234_FM.pth')['parallel1'])
        self.parallel1[1].load_state_dict(torch.load('./models/RGBT234_OCC.pth')['parallel1'])  
        self.parallel1[2].load_state_dict(torch.load('./models/RGBT234_SC.pth')['parallel1'])
        # parallel2      
        self.parallel2[0].load_state_dict(torch.load('./models/RGBT234_FM.pth')['parallel2'])
        self.parallel2[1].load_state_dict(torch.load('./models/RGBT234_OCC.pth')['parallel2'])  
        self.parallel2[2].load_state_dict(torch.load('./models/RGBT234_SC.pth')['parallel2'])
        # parallel3
        self.parallel3[0].load_state_dict(torch.load('./models/RGBT234_FM.pth')['parallel3'])
        self.parallel3[1].load_state_dict(torch.load('./models/RGBT234_OCC.pth')['parallel3'])  
        self.parallel3[2].load_state_dict(torch.load('./models/RGBT234_SC.pth')['parallel3'])
        # parallel1_v
        self.parallel1_v[0].load_state_dict(torch.load('./models/RGBT234_TC.pth')['parallel1_v'])
        self.parallel1_v[1].load_state_dict(torch.load('./models/RGBT234_ILL.pth')['parallel1_v'])
        # parallel2_v
        self.parallel2_v[0].load_state_dict(torch.load('./models/RGBT234_TC.pth')['parallel2_v'])
        self.parallel2_v[1].load_state_dict(torch.load('./models/RGBT234_ILL.pth')['parallel2_v'])
        # parallel3_v
        self.parallel3_v[0].load_state_dict(torch.load('./models/RGBT234_TC.pth')['parallel3_v'])
        self.parallel3_v[1].load_state_dict(torch.load('./models/RGBT234_ILL.pth')['parallel3_v'])
        # parallel1_i
        self.parallel1_i[0].load_state_dict(torch.load('./models/RGBT234_TC.pth')['parallel1_i'])
        self.parallel1_i[1].load_state_dict(torch.load('./models/RGBT234_ILL.pth')['parallel1_i'])
        # parallel2_i
        self.parallel2_i[0].load_state_dict(torch.load('./models/RGBT234_TC.pth')['parallel2_i'])
        self.parallel2_i[1].load_state_dict(torch.load('./models/RGBT234_ILL.pth')['parallel2_i'])
        # parallel3_i
        self.parallel3_i[0].load_state_dict(torch.load('./models/RGBT234_TC.pth')['parallel3_i'])
        self.parallel3_i[1].load_state_dict(torch.load('./models/RGBT234_ILL.pth')['parallel3_i'])
        
        self.guidance1_conv0_12.load_state_dict(torch.load('./models/RGBT234_x1guidex2.pth')['guidance1_conv0_12'])
        self.guidance1_conv1_12.load_state_dict(torch.load('./models/RGBT234_x1guidex2.pth')['guidance1_conv1_12'])
        self.guidance2_conv0_12.load_state_dict(torch.load('./models/RGBT234_x1guidex2.pth')['guidance2_conv0_12'])
        self.guidance2_conv1_12.load_state_dict(torch.load('./models/RGBT234_x1guidex2.pth')['guidance2_conv1_12'])
        self.guidance3_conv0_12.load_state_dict(torch.load('./models/RGBT234_x1guidex2.pth')['guidance3_conv0_12'])
        self.guidance3_conv1_12.load_state_dict(torch.load('./models/RGBT234_x1guidex2.pth')['guidance3_conv1_12'])
        
        self.guidance1_conv0_21.load_state_dict(torch.load('./models/RGBT234_x2guidex1.pth')['guidance1_conv0_21'])
        self.guidance1_conv1_21.load_state_dict(torch.load('./models/RGBT234_x2guidex1.pth')['guidance1_conv1_21'])
        self.guidance2_conv0_21.load_state_dict(torch.load('./models/RGBT234_x2guidex1.pth')['guidance2_conv0_21'])
        self.guidance2_conv1_21.load_state_dict(torch.load('./models/RGBT234_x2guidex1.pth')['guidance2_conv1_21'])
        self.guidance3_conv0_21.load_state_dict(torch.load('./models/RGBT234_x2guidex1.pth')['guidance3_conv0_21'])
        self.guidance3_conv1_21.load_state_dict(torch.load('./models/RGBT234_x2guidex1.pth')['guidance3_conv1_21'])
