...
class MDNet(nn.Module):
    ...
    def load_model(self, model_path):
        ...
        ill = torch.load('./models/RGBT234_ILL.pth')
        self.parallel1_v.load_state_dict(ill['parallel1_v'])
        self.parallel2_v.load_state_dict(ill['parallel2_v'])
        self.parallel3_v.load_state_dict(ill['parallel3_v'])
        self.parallel1_i.load_state_dict(ill['parallel1_i'])
        self.parallel2_i.load_state_dict(ill['parallel2_i'])
        self.parallel3_i.load_state_dict(ill['parallel3_i'])
