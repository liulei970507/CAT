...
from model_stage2_x1guidex2 import *
from pretrain_options import *
from tracker_stage2_x1guidex2 import *
import numpy as np
...
def train_mdnet():
    ...
    for i in range(pretrain_opts['n_cycles']):
        ...
        if cur_score > best_score:
            ...
            if pretrain_opts['use_gpu']:
                model = model.cpu()
            states = {'guidance1_conv0_12': model.guidance1_conv0_12.state_dict(),
...
if __name__ == "__main__":
    ...
    parser.add_argument("-set_type", default = 'RGBT234_TC')
    parser.add_argument("-padding_ratio", default = 5., type =float)
    parser.add_argument("-model_path", default ="/home/liulei/cat/models/RGBT234_x1guidex2.pth", help = "model path")
