...
def train_mdnet():
    ...
    for i in range(pretrain_opts['n_cycles']):
        ...
        if cur_score > best_score:
            ...
            print "Save model to %s" % pretrain_opts['model_path']+'.pth'
            torch.save(states, pretrain_opts['model_path']+'.pth')
            if cur_score>0.95:
...
if __name__ == "__main__":
    ...
    parser.add_argument("-model_path", default ="/home/liulei/cat/models/RGBT234_ALLv2", help = "model path")
