...
set_type = 'RGBT234' # set datasets GTOT or RGBT234.
seq_home = '/DATA/liulei/'+set_type +'/'
challenge_type = 'SC' # set challenge type. FM~Fast	Motion; OCC~Occlusion; SC~Scale; Variation; ILL~Illumination Variation; TC~Thermal Crossover; ALL~Whole dataset
if set_type=='GTOT':
    seqlist_path = '/DATA/liulei/GTOT.txt'
    output_path = '/home/liulei/cat/data/GTOT_'+challenge_type+'.pkl'
elif set_type == 'RGBT234':
    seqlist_path = '/DATA/liulei/RGBT234.txt'
